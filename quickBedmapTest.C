...
void quickBedmapTest() {
    ...
    BedmapTable *iceTable = new BedmapTable (RyansCons::kIceThickness);
//     BedmapTable *groundBedTable = new BedmapTable (RyansCons::kGroundBed);
//     cout << "Here" << endl;
//     BedmapTable *waterDepthTable = new BedmapTable (RyansCons::kWaterDepth);
//     BedmapTable *bathTable = new BedmapTable (RyansCons::kBathymetry);
//     BedmapTable *surfaceTable = new BedmapTable (RyansCons::kSurfaceHeight);
//     BedmapTable *bedElevationTable = new BedmapTable (RyansCons::kBedElevation);

...
public:
    ...
    Double_t getCrust2Data(Double_t x, Double_t y, RyansCons::Crust2Type_t type);
//    Double_t getData(Double_t x, Double_t y, RyansCons::WorldModelType_t type);
//    RyansCons::WorldModelMaterial_t getMaterial(Double_t point[3]);
    Double_t getSurface(Double_t x, Double_t y);
    Double_t getIceThickness(Double_t x, Double_t y);
